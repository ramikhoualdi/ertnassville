...
const AddElevator = ({navigation}) => {
  console.log('AddElevator screen !');
  const dispatch = useDispatch();
  const {addElevatorSuccess, errors} = useSelector(mapState);
  ...
  const handleRegister = () => {
    ...
    if (checked == 'true') {
      ...
      console.log({photo, title, phone});
      dispatch(saveElevator(photo, title, phone));
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView}>
        ...
        <View style={styles.headerTitle}>
          <Text style={styles.headerText1}>Add Evacuation plan</Text>
        </View>
        <View>
        ...
        <View style={styles.content}>
          ...
          <View style={styles.inputField}>
            <Text style={styles.label}>Evacuation plan Details</Text>
            <TextInput
              style={styles.input}
              onChangeText={onChangeTitle}
              value={title}
              placeholder="Evacuation plan Details"
              maxLength={100}
