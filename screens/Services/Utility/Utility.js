  ...
  return (
    <View>
      ...
      <Dialog.Container visible={visibleDone}>
        <Dialog.Title>Utility Done</Dialog.Title>
        <Dialog.Description>
          Do you want to set this Utility to Done?
        </Dialog.Description>
      ...
      <Dialog.Container visible={visibleDelete}>
        <Dialog.Title>Utility deletion</Dialog.Title>
        <Dialog.Description>
          Do you want to delete this Utility? You cannot undo this action.
        </Dialog.Description>
