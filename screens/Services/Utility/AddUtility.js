...
const AddUtility = ({navigation}) => {
  console.log('AddMatter Screen !');
  const dispatch = useDispatch();
  const {addUtilitySuccess, errors} = useSelector(mapState);
  console.log(
    'addUtilitySuccess =>',
    addUtilitySuccess,
    'errors =>',
  ...
  const handleRegister = () => {
    ...
    if (checked == 'true') {
      ...
      dispatch(saveUtility(emergency, title, phone));
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView}>
        ...
        <View style={styles.headerTitle}>
          <Text style={styles.headerText1}>Add Utility</Text>
        </View>
        ...
        <View style={styles.content}>
          ...
          <View style={styles.inputField}>
            <Text style={styles.label}>Utility Details</Text>
            <TextInput
              style={styles.input}
              onChangeText={onChangeTitle}
              value={title}
              placeholder="Utility Details"
              maxLength={50}
