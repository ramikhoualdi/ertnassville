...
const AddPrecaution = ({navigation}) => {
  console.log('AddDescription screen !');
  const dispatch = useDispatch();
  const {addPrecautionSuccess, errors} = useSelector(mapState);
  console.log(
  ...
  const handleRegister = () => {
    ...
    if (checked == 'true') {
      ...
      dispatch(savePrecaution(emergency, title, phone));
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView}>
        ...
        <View style={styles.headerTitle}>
          <Text style={styles.headerText1}>Add Precaution</Text>
        </View>
        ...
        <View style={styles.content}>
          ...
          <View style={styles.inputField}>
            <Text style={styles.label}>Precaution Details</Text>
            <TextInput
              style={styles.input}
              onChangeText={onChangeTitle}
              value={title}
              placeholder="Precaution Details"
              maxLength={50}
