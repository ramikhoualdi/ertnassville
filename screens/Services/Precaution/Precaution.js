  ...
  return (
    <View>
      ...
      <Dialog.Container visible={visibleDone}>
        <Dialog.Title>Precaution Done</Dialog.Title>
        <Dialog.Description>
          Do you want to set this Precaution to Done?
        </Dialog.Description>
      ...
      <Dialog.Container visible={visibleDelete}>
        <Dialog.Title>Precaution deletion</Dialog.Title>
        <Dialog.Description>
          Do you want to delete this Precaution? You cannot undo this action.
        </Dialog.Description>
