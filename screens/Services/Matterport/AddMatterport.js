...
const AddMatterport = ({navigation}) => {
  console.log('AddMatter Screen !');
  const dispatch = useDispatch();
  const {addMatterportSuccess, errors} = useSelector(mapState);
  console.log(
  ...
  const handleRegister = () => {
    ...
    if (checked == 'true') {
      ...
      dispatch(saveMatterport(emergency, title, phone));
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView}>
        ...
        <View style={styles.headerTitle}>
          <Text style={styles.headerText1}>Add Matterport</Text>
        </View>
        ...
        <View style={styles.content}>
          ...
          <View style={styles.inputField}>
            <Text style={styles.label}>Matterport Details</Text>
            <TextInput
              style={styles.input}
              onChangeText={onChangeTitle}
              value={title}
              placeholder="Matterport Details"
              maxLength={50}
