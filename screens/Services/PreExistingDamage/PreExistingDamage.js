...
const PreExistingDamage = props => {
  ...
  console.log('props');
  console.log(props);
  console.log('From Matterport Components =>');
  ...
  const handleDone = () => {
    setVisibleDone(false);
    dispatch(donePreExistingDamage(nb));
  };
  ...
  const handleDelete = () => {
    setVisibleDelete(false);
    dispatch(deletePreExistingDamage(nb));
  };
  return (
    <View>
      {auth().currentUser ? (
      ...
      <Dialog.Container visible={visibleDone}>
        <Dialog.Title>PreExisting Damage Done</Dialog.Title>
        <Dialog.Description>
          Do you want to set this PreExisting Damage to Done?
        </Dialog.Description>
      ...
      <Dialog.Container visible={visibleDelete}>
        <Dialog.Title>PreExisting Damage deletion</Dialog.Title>
        <Dialog.Description>
          Do you want to delete this PreExisting Damage? You cannot undo this action.
        </Dialog.Description>
...
export default PreExistingDamage;
