...
const AddAccess = ({navigation}) => {
  console.log('AddAccess screen !');
  const dispatch = useDispatch();
  const {addAccessSuccess, errors} = useSelector(mapState);
  console.log(
    'addAccessSuccess =>    ',
    addAccessSuccess,
    'errors  =>  ',
  ...
  const handleRegister = () => {
    ...
    if (checked == 'true') {
      ...
      dispatch(saveAccess(emergency, title, phone));
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView}>
        ...
        <View style={styles.headerTitle}>
          <Text style={styles.headerText1}>Add Access</Text>
        </View>
