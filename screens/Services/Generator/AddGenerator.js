...
const AddGenerator = ({navigation}) => {
  console.log('AddGenerator screen !');
  const dispatch = useDispatch();
  const {addGeneratorSuccess, errors} = useSelector(mapState);
  console.log(
    'addGeneratorSuccess =>',
    addGeneratorSuccess,
    'errors =>',
  ...
  const handleRegister = () => {
    ...
    if (checked == 'true') {
      ...
      dispatch(saveGenerator(emergency, title, phone));
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView}>
        ...
        <View style={styles.headerTitle}>
          <Text style={styles.headerText1}>Add Generator</Text>
        </View>
        ...
        <View style={styles.content}>
          ...
          <View style={styles.inputField}>
            <Text style={styles.label}>Generator Details</Text>
            <TextInput
              style={styles.input}
